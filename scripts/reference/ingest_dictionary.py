...
extract, streams it, and loads three things into languages/<pack>/reference/dictionary.db:
...
Reusable for any language on kaikki.org:
  ...
  python3 scripts/reference/ingest_dictionary.py --lang ancient-greek --kaikki-name "Ancient Greek"
  python3 scripts/reference/ingest_dictionary.py --lang latin --file /path/to/dump.jsonl.gz
"""
import argparse
import gzip
import json
